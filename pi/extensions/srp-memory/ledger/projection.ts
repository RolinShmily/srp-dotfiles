 ...
 * first-valid-record-wins order, with folded drops applied.
 */
...
/** What a fresh session sees: the observations folded into the last compaction. */
 ...
 * future visible projection can replay it.
 */
