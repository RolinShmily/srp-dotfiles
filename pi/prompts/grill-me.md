...
- 只要 `ask_user_question` 工具可用，**必须优先、积极调用**它向我提出必要的问题，展开单步或分阶段的结构化质询：
...
#### 3. 严格共识交付，未确认前严禁行动
- 向我提问，直到你 100% 明确并理解需要执行的目标、架构与全部细节。
- 当决策树的所有分支均已探索完毕、无任何隐性假设遗漏时，质询结束。
- 结构化汇总最终达成的明确方案与共识结论，**在我明确确认我们已达成共识之前，绝对不要直接对代码或系统展开实质性修改**。
